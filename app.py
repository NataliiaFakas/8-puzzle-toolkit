...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.img_backicon = tk.PhotoImage(file="img/back-icon.png")
        ...
        self.img_nexticon = tk.PhotoImage(file="img/next-icon.png")
        ...
        self.img_fastforwardicon = tk.PhotoImage(file="img/fast-forward-icon.png")
        ...
        self.img_fastbackwardicon = tk.PhotoImage(file="img/fast-backward-icon.png")
        ...
        self.img_stopicon = tk.PhotoImage(file="img/stop.png")
        ...
        self.img_reseticon = tk.PhotoImage(file="img/reset-icon.png")
        ...
        self.img_solveicon = tk.PhotoImage(file="img/solve-icon.png")
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly", values=algorithms)
        ...
        self.algolabel.place(anchor="center", x=560, y=230)
        ...
        self.img_inputicon = tk.PhotoImage(file="img/input-icon.png")
        self.enterstatebutton.configure(
            cursor="hand2", text='Set initial state', image=self.img_inputicon, compound="left")
        ...
        self.gif = [tk.PhotoImage(file='img/loading.gif', format='gif -index %i' % i) for i in range(10)]
    ...
    def readyToSolve():
        ...
        :return: boolean
        """
        return initialState is not None and algorithm is not None and utils.isSolvable(initialState)
